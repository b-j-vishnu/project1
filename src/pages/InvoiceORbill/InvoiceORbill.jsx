...
import ItineraryFilter from "../ItineraryANDquotation/ItineraryFilter";
              ...
              <thead className="">
                <tr className="bg-gray-300 text-xs py-7 mb-6  poppins-medium text-gray-500 ">
                  <th className="py-2 pl-4">
                    <input type="checkbox" className="w-4 focus:ring-0 h-4" />
                  </th>
                  <th>Action</th>
                ...
                {currentItems.map((person, index) => (
                  <tr key={index} className=" text-xs">
                    <td className="pt-5 pl-4    ">
                      <input
                        type="checkbox"
                        className="w-4 outline-none  focus:ring-0 h-4"
                      />
                    </td>
                    <td className="pt-5 ">
                      <Link
                        to={`/invoice/viewInvoice/${person.id.replace(
                          "#",
                          ""
                        )}`}
